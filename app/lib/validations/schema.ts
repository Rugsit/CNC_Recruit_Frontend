...
export const formSchema = z.object({
    nisitId: z.string().regex(/^\d{10}$/, { message: "*กรุณาระบุรหัสนิสิต 10 หลัก" }),
    ...
    grade: z.preprocess((val) => parseFloat(val as string), z.number().min(0.0).max(4.0, "เกรดต้องอยู่ระหว่าง 0.00 - 4.00")),
