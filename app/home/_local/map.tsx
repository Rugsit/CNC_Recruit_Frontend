        ...
        <div className="space-y-6 w-full flex flex-col items-center">
          <div className="space-y-2 flex flex-col items-center text-center">
            <div className="flex items-center gap-3 justify-center">
              ...
              <span className="font-bold text-xl text-[#3B434F]">
                SC45 ชั้น 8 ห้อง 833
              </span>
            </div>
            <div className="space-y-1">
              <p className='text-[#3B434F]'>มหาวิทยาลัยเกษตรศาสตร์</p>
              <p className='text-[#3B434F]'>คณะวิทยาศาสตร์ ภาควิชาวิทยาการคอมพิวเตอร์</p>
            </div>
          </div>
          ...
          <div className="space-y-2 flex flex-col items-center text-center">
            <div className="flex items-center gap-3 justify-center">
              <Building width={80} height={80} />
              <span className="font-bold text-xl text-[#3B434F]">
                50 ถนนงามวงศ์วาน
              </span>
            </div>
            <div>
              <p className='text-[#3B434F]'>แขวงลาดยาว เขตจตุจักร กรุงเทพฯ 10900</p>
            </div>
          </div>
        </div>
      </div>
