  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        else console.error('Fetching data failed!');
      }
    };
  ...
  return (
    <section>
      ...
      >
        <div
          className={clsx(
            'transition-all duration-1000 h-[100vh]  flex items-center justify-center pt-[100px]',
            {
      ...
      <section
        className='bg-gradient-to-t from-white to-primary pt-[200px]'
        id='timeline'
      >
        <Timeline />
        <div
          className='w-full max-w-[1500px] mx-auto pt-[300px] pb-[200px]'
          id='location'
        >
          <Map />
        </div>
