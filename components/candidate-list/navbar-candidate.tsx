...
export default function NavbarCandidate({
  ...
  return (
    <nav className='text-bold grid grid-cols-3 w-full max-sm:text-[10px]'>
      <Link
        className={clsx(
          'max-sm:p-2 sm:p-4 rounded-l-full transition-all flex items-center justify-center',
          {
      ...
      <Link
        className={clsx(
          'max-sm:p-2 sm:p-4  transition-all text-center flex items-center justify-center',
          {
      ...
      <Link
        className={clsx(
          'max-sm:p-2 sm:p-4  rounded-r-full transition-all text-center flex items-center justify-center',
          {
